#!/usr/bin/env python3
"""
CredNX Text Formatter
=====================

A robust text formatter for bank statement processing that extracts and structures
transaction data from PDF text content. Specifically designed to handle:
...
class TransactionFormatter:
    ...
    Specifically designed for bank statement format with page headers
    """
        ...
        try:
            ...
            while i < len(lines):
                ...
                if (re.match(r'\d{10,}', line) or  # Pure digits
                    ...
                    # Check if this line contains both date and narration (e.g., "01/03/25 UPI-MAHENDARBAHETIOKICIC-MAHENDAR.BAHETI")
